...
Checklist detalhado do que já foi implementado, versão por versão. Para o planejamento original (motivação, escopo de cada versão), veja [planejamento.md](./planejamento.md).
